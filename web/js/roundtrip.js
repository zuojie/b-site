var _und = "undefined",
	__adroll = window.__adroll || {
		...
		macro_url_params: function(a, b, c, d, e) {
			...
			!j && e && g.push(["desturl", ""]);
			k && 0 === k.indexOf("http") ? (e = f, "g" == adroll_ext_network && (e = d ? function(a) {
				return a
			...
			i && (a = this.parseUri(unescape(i)), g.push(["site_url", f("http://" + a.host)]), c && (g.push(["adroll_width",
				f(adroll_width)
		...
		get_product_id_from_dom: function(a) {
			var b = null,
				c;
			a.path && (window.jQuery ? (c = jQuery(a.path), c.length && (c = c.eq(0), b = "text" == a.attribute ? c.text() : c.attr(a.attribute))) : window.Prototype && window.$$ ? (c = $$(a.path), c.length && (c = c[0], b = "text" == a.attribute ? c.innerText && !window.opera ?
