...
<head>
    ...
    <script>
        DD_belatedPNG.fix('.message-tip, .file-info-detail i, .suggest, .close');
    </script>
    <![endif]-->   
    ...
    <script type="text/javascript" src="./js/component-v2.js" id="lim:component"></script>
    <link id="invite_style" type="text/css" rel="stylesheet" href="css/invite.css">
</head>
<body lim:visitorcapacity="1">
<div id="doc1" class="file-trans">
    <div id="hd">
...
<script type="text/javascript" src="./js/business.js" data-main="business/filetran"></script>
...
<div>
    <div id="lim:sharedObject" style="position:absolute;z-index:-3;top:0;left:0;visibility:hidden">
...
<div id="lim_mini_chat" style="display: none;">
    <div>
        <div class="mini_wrap" title="按住鼠标，可以拖动我哟!"></div>
    </div>
</div>
<div id="lim_mini" style="display: none;">
    <div class="bg_wrap"></div>
    <div id="lim_restore"></div>
    <iframe src="about:blank" id="lim_mini_effects" name="lim_mini_effects" scrolling="0" border="0" frameborder="0" allowtransparency="true"></iframe>
</div>
