...
class bTemplate {
	...
	// Place this file and template directory at the same layer
	...
	/*--------------------------------------------------------------*\
		Method: __construct()
		The construct function to initialize the $this->base_path
		Caution: when you use this file, you need to create a directory 
		named "template" at the same layer.
	\*--------------------------------------------------------------*/
	public function __construct() {
		$this->base_path = realpath(dirname(__FILE__)) . "/template/";
	}
