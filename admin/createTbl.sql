...
CREATE TABLE `user_tbl` (
  ...
  `mail_addr` varchar(128) NOT NULL default 'null' COMMENT '常用邮箱',
...
INSERT INTO `user_tbl` (`name`, `password`, `mail_addr`, `phone`, `money`, `ty_money`) VALUES
('丁磊', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'pjay@163.com', '12345678', 123.0, 0.0);